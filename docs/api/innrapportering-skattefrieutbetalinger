...
datatable: true
tags: [ API, skattefrieutbetalinger, vitenskapelig, forskning, yrkesopplæring ]
keywords: [ grunnlagsdata ]
last_updated: Mar 03, 2025
hide_table_of_contents: true
---

<Summary>Tjeneste for innrapportering Skattefrie utbetalinger fra offentlige myndigheter (RF-1319)</Summary>
...
* __POST innsending__: Mottar tredjepartsopplysninger for skattefrie utbetalinger fra offentlige myndigheter. Ett kall mot API-et er en rapportering for en organisasjon gitt av en oppgavegiver og som gjelder et inntektsår.
...
| Leveranse                 | utbetalingsmaaned               | Måneden som oppgaven gjelder for                                                                                                                |
...
| OppgaveSkattefriUtbetaling| utbetalt                        | Beløpet som er utbetalt for ytelsestypen i utbetalingsmåneden                                                                                   |
| OppgaveSkattefriUtbetaling| tilbakebetalt                   | Hvis tilbakebetalt beløp så oppgis tilbakebetalt beløp her                                                                                      |
| OppgaveSkattefriUtbetaling| ytelsestype                     | Angivelse av stønadsordning for skattefri utbetaling fra offentlige myndigheter                                                                 |
| OppgaveSkattefriUtbetaling| oppgaveeier                     | Person som har gitt skattefrie utbetaling fra offentlige myndigheter                                                                            |
...
| Oppgaveoppsummering       | sumUtbetalt                     | Sum av alle utbetalt verdiene i oppgavene til en leveranse                                                                                      |
| Oppgaveoppsummering       | sumTilbakebetalt                | Sum av alle tilbakebetalt verdiene i oppgavene til en leveranse                                                                                 |
</TabItem>
