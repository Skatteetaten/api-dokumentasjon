...
Betjeningskartet er en tjeneste for overgangsperioden. beskrivelsen av parameterne, endepunkter og respons ligger her [OpenAPI spesifikasjon for betjeningskartet](https://app.swaggerhub.com/apis/skatteetaten/utleggsbegjaering-betjeningskartet-api)
...
| :--- | :--- | :--- | :--- | :--- |
| BEGJAERING_FREM_I_TID | Nei | Dato for begjaering er ugyldig | Dato for begjaering kan ikke være frem i tid | Dato for begjæring kan ikke være frem i tid |
...
| ENTEN_SAKSKOSTNADER_FOR_SKRIVING_ELLER_SAKSKOSTNADER | Nei | Det er kun lov å be om sakskostnad for skriving eller sakskostnader | Det er ikke lov å anføre både Sakskostnader for skriving og Sakskostnader. Man kan kun be om en slik kostnad | Det er oppgitt mer enn en Sakskostnad for skriving eller Sakskostnad %kravreferanse |
| ER_IKKE_HOVEDENHET | Nei | Saksøker er ikke angitt med hovedenhet | Kun hovedenhet har partsevne |  |
| GJENSTAAENDEBELOEP_MAA_STEMME_MED_INNBETALINGER_OG_KRAVENDRINGER | Nei | Gjenstående beløp på begjæringsdato er ikke i henhold til rapportere innbetalinger og kravendringer | Gjenstående beløp må være Opprinnelig beløp minus innbetalinger og kravendringer som er gjort til og med begjæringsdato |  |
| HOVEDKRAV_KAN_BARE_HA_ETT_TVANGSGRUNNLAG | Nei | Hovedkrav kan bare ha ett tvangsgrunnlag | Hovedkrav kan bare bli pekt på av ett tvangsgrunnlag | Hovedkrav %kravReferanseHovedkrav har for mange tvangsgrunnlag %tvangsgrunnlagListe |
| HOVEDKRAV_KAN_IKKE_RELATERES_TIL_ANDRE_KRAV | Nei | Hovedkrav skal ligge på toppnivå og kan derfor ikke peke på andre krav  | Hovedkrav skal være på toppnivå og kan derfor ikke peke på andre krav | Hovedkrav %kravReferanse1 peker på krav %kravReferanse2 |
| HOVEDKRAV_MAA_HA_TVANGSGRUNNLAG | Nei | Hovedkrav må ha tvangsgrunnlag | Hovedkrav må bli pekt på av et tvangsgrunnlag | Hovedkrav %kravreferanse mangler tvangsgrunnlag |
...
| KRAV_GYLDIG_KRAVJUSTERINGSDATO | Nei | Innbetalinger og endringer på krav må ha gyldig dato | Dato for innbetaling eller kravendring må være før begjæringsdato |  |
...
| PRIORITET_MANGLER | Nei | Bestemt dekningsrekkefølge mangler eller må fjernes | Bestemt dekningsrekkefølge må angis på alle eller ingen kravposter | Når én kravpost har fått en bestemt dekningsrekkefølge («prioritet i sak»), må også de øvrige kravpostene få en bestemt dekningsrekkefølge. |
| PRIORITET_MANGLER_PÅ_RENTEOPPLYSNINGER | Nei | Bestemt dekningsrekkefølge mangler eller må fjernes | Bestemt dekningsrekkefølge må angis på alle eller ingen kravposter | Når én kravpost har fått en bestemt dekningsrekkefølge («prioritet i sak»), må også fremtidige renter få en bestemt dekningsrekkefølge. |
| PRIORITET_MANGLER_PÅ_RETTSGEBYR | Nei | Bestemt dekningsrekkefølge mangler eller må fjernes | Bestemt dekningsrekkefølge må angis på alle eller ingen kravposter | Når én kravpost har fått en bestemt dekningsrekkefølge («prioritet i sak»), må også fremtidige renter få en bestemt dekningsrekkefølge. |
...
| RENTEKRAV_MAA_RELATERES_TIL_ET_RENTEBAERENDE_KRAV | Nei | Rentekrav må peke på et rentebærende krav, dvs. hovedkrav, tidligere rettslig sakskostnad eller utenrettslig kostnad | Rentekrav må peke på ett, og bare ett, rentebærende krav. Rentebærende kravtyper er hovedkrav, tidligere rettslig sakskostnad eller utenrettslig kostnad | Rentekrav (%rentekravReferanse) peker ikke på ett rentebærende krav %kravReferanse |
| SAKSKOSTNADER_FOR_SKRIVING_KAN_IKKE_HA_TVANGSGRUNNLAG | Nei | Sakskostnader for skriving kan ikke ha tvangsgrunnlag | Sakskostnader for skriving kan ikke bli pekt på av et tvangsgrunnlag | Sakskostnader for skriving %sakskostnaderKravReferanse blir pekt på av tvangsgrunnlag %tvangsgrunnlag |
| SAKSKOSTNADER_FOR_SKRIVING_KAN_IKKE_RELATERES_TIL_ANDRE_KRAV | Nei | Sakskostnader for skriving kan ikke peke på andre krav | Sakskostnader for skriving skal være på toppnivå og kan derfor ikke peke på andre krav  | Sakskostnader for skriving %sakskostnaderKravReferanse peker på krav %relatertKravReferanse |
| SAKSKOSTNADER_KAN_IKKE_HA_TVANGSGRUNNLAG | Nei | Sakskostnader kan ikke ha tvangsgrunnlag | Sakskostnader kan ikke bli pekt på av et tvangsgrunnlag | Sakskostnader %sakskostnaderKravReferanse blir pekt på av tvangsgrunnlag %tvangsgrunnlagReferanser |
| SAKSKOSTNADER_KAN_IKKE_RELATERES_TIL_ANDRE_KRAV | Nei | Sakskostnader kan ikke peke på andre krav | Sakskostnader skal være på toppnivå og kan derfor ikke peke på andre krav | Sakskostnader %sakskostnaderKravReferanse peker på krav %relatertKravReferanse |
...
| TIDLIGERE_RETTSLIGE_SAKSKOSTNADER_KAN_BARE_HA_ETT_TVANGSGRUNNLAG | Nei | Tidligere rettslig sakskostnad kan bare ha ett tvangsgrunnlag. | Tidligere rettslig sakskostnad kan bare bli pekt på av ett tvangsgrunnlag  | Tidligere rettslig sakskostnad %kravReferanseTidligereRettsligeSakskostnader har for mange tvangsgrunnlag %tvangsgrunnlagListe |
| TIDLIGERE_RETTSLIGE_SAKSKOSTNADER_KAN_BARE_RELATERES_TIL_HOVEDKRAV | Nei | Tidligere rettslig sakskostnad kan bare relateres til hovedkrav. | Dersom tidligere rettslig sakskostnad peker ett eller flere krav så må dette være hovedkrav | Tidligere rettslig sakskostnad %sakskostnaderKravReferanse peker på krav %relatertKravReferanse |
| TIDLIGERE_RETTSLIGE_SAKSKOSTNADER_MAA_HA_TVANGSGRUNNLAG | Nei | Tidligere rettslig sakskostnad må ha tvangsgrunnlag. | Tidligere rettslig sakskostnad må bli pekt på direkte av et tvangsgrunnlag  | Tidligere rettslig sakskostnad %kravreferanse mangler tvangsgrunnlag |
| TVANGSGRUNNLAG_GYLDIG_TYPE | Nei | Tvangsgrunnlaget må ha en gyldig type | Tvangsgrunnlaget må ha en type som er i samsvar med begjæringstypen. Kombinert utlegg og forlik kan ikke ha alminnelige tvangsgrunnlag. Utlegg kan ikke ha skriftlig meddelelse |  |
| TVANGSGRUNNLAG_UGYLDIGE_KRAVREFERANSER | Nei | Begjæringens tvangsgrunnlag peker på krav som ikke eksisterer | Begjæringens tvangsgrunnlag må peke på krav | Begjæringens tvangsgrunnlag med kravreferanse %kravreferanse peker på krav som ikke eksisterer |
...
| UGYLDIG_VEDLEGG_TVANGSGRUNNLAG | Nei | Tvangsgrunnlag har vedlegg av feil type | Begjæringens tvangsgrunnlag må ha vedlegg av korrekt type | Vedlegg for tvangsgrunnlag av type %type med dato %dato må være av type tvangsgrunnlag |
...
| UTENRETTSLIGE_KOSTNADER_KAN_BARE_RELATERES_TIL_HOVEDKRAV | Nei | Utenrettslig kostnad kan bare relateres til hovedkrav. | Dersom utenrettslig kostnad peker ett eller flere krav så må dette være hovedkrav | Utenrettslig kostnad %sakskostnaderKravReferanse peker på krav %relatertKravReferanse |
| UTENRETTSLIGE_KOSTNADER_MAA_RELATERES_TIL_HOVEDKRAV_MED_SAMME_ALLMINNELIG_TVANGSGRUNNLAG | Nei | Utenrettslig kostnad må peke på hovedkrav med samme  alminnelig tvangsgrunnlag | Dersom utenrettslig kostnad peker på flere hovedkrav med alminnelig tvangsgrunnlag, så må det være samme tvangsgrunnlag for alle. | Utenrettslig kostnad (%utenrettsligeKostnaderKravReferanse) peker på hovedkrav med ulike alminnelig tvangsgrunnlag %relatertAlminneligeTvangsgrunnlag |
| UTENRETTSLIGE_KOSTNADER_MAA_RELATERES_TIL_HOVEDKRAV_MED_SAMME_TYPE_TVANGSGRUNNLAG | Nei | Utenrettslig kostnad som peker på flere hovedkrav må peke på hovedkrav med samme type tvangsgrunnlag (alminnelig eller særlig) | Dersom utenrettslig kostnad peker på flere hovedkrav så må hovedkravene ha samme type tvangsgrunnlag (alminnelig eller særlig) | Utenrettslig kostnad (%utenrettsligeKostnaderKravReferanse) peker på hovedkrav med ulike tvangsgrunnlag %relatertTvangsgrunnlag |
| UTENRETTSLIGE_KOSTNADER_UTEN_HOVEDKRAV_MAA_HA_TVANGSGRUNNLAG | Nei | Utenrettslig kostnad som ikke peker på hovedkrav må ha tvangsgrunnlag | Dersom utenrettslig kostnad ikke peker på noen hovedkrav så må tvangsgrunnlaget peke direkte på utenrettslig kostnad. | Utenrettslig kostnad (%utenrettsligeKostnaderKravReferanse) uten tilknyttet hovedkrav må ha tvangsgrunnlag |
| UTLEGG_OG_FORLIKSKLAGE_KAN_IKKE_HA_ALMINNELIG_TVANGSGRUNNLAG | Nei | Kombinert utlegg og forliksklage kan ikke ha alminnelig tvangsgrunnlag | Dersom begjæringen gjelder kombinert utlegg og forliksklage (tvangsfullbyrdelsestype) kan den ikke inneholde alminnelig tvangsgrunnlag | Begjæringen gjelder kombinert utlegg og forliksklage og kan derfor ikke inneholde alminnelig tvangsgrunnlag. Tvangsgrunnlag: %tvangsgrunnlagliste |
...
### b) Parter - Utleggsbegjæring v2.1
...
### c) Generelle elementer - Utleggsbegjæring v2.1
...
* **eksternSaksreferanse** er en unik identifikator for tvangsgrunnlaget for fremtidig bruk. Vil bli fjernet i neste versjon av modellen.
...
* **forkynnelsesdato** er dato når tvangsgrunnlaget ansees mottatt hos saksøkte. Vil bli fjernet i neste versjon av modellen.
* **forpliktet** er den eller de som i følge tvangsgrunnlaget er ansvarlig for pengekravet og kan få en utleggsbegjæring rettet mot seg. Vil bli fjernet i neste versjon av modellen.
* **berettiget** er den eller de som i følge tvangsgrunnlaget, kan be om om hjelp til å få inndrevet pengekravet sitt (sette frem en utleggsbegjæring). Det gjelder også de som lovlig har ervervet/kjøpt opp kravet. Vil bli fjernet i neste versjon av modellen.
...
* **skyldner** er part eller parter som har en ubetinget betalingsforpliktelse overfor en eller flere kreditorer. Vil bli fjernet i neste versjon av modellen
* **kreditor** er part eller parter som har en ubetinget rett til å motta betaling fra en skyldner. Vil bli fjernet i neste versjon av modellen
...
- **vedtakendeMyndighet** er myndigheten som har fastsatt tvangsmulkten. Trenger ikke å være samme som kreditor og/eller saksøker. Vil bli fjernet i neste versjon av modellen
* **skriftligMeddelelse**
- **kravetsGrunnlag** er ment å kort beskrive hva kravet gjelder, feks "treningsavgift januar 2025". Vil bli fjernet i neste versjon av modellen
...
- **vitne**. For en del gjeldsbrev er det krav om vitnepåtegninger for at de skal være gyldige. I så fall er det krav om identifisering av to myndige vitner. Vil bli fjernet i neste versjon av modellen.
...
- **inndrivelsesklausul** =true angir at det finnes en bestemmelse om at gjelden kan inndrives uten søksmål. Vil bli fjernet i neste versjon av modellen.
...
Innsendinger av vedlegg og utleggsbegjæringer i testmiljøet vil ikke bli videre behandlet av Skattetaten og det skal kun benyttes syntetisk data. Dette kan hentes fra ‘Syntetisk Norge’ og disse hentes ut med Tenor Testdatasøk.
