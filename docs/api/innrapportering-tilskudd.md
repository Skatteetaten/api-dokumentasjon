...
[SwaggerHub](https://app.swaggerhub.com/apis/skatteetaten/innrapportering-tilskudd-api/1.0.0)
...
```
https://innrapporteringtilskuddforskningyrkesopplaering.api.{env}.no/v1/{inntektsaar}
```
...
For spesifikke URL-er til testmiljø hos Skatteetaten, se [SwaggerHub](https://app.swaggerhub.com/apis/skatteetaten/innrapportering-tilskudd-api/1.0.0).
