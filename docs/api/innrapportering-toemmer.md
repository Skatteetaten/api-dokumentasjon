---
title: Innrapportering tømmer API
slug: /api/innrapportering-toemmer
folder: api
sidebar: mydoc_sidebar
datatable: true
tags: [ API, primærnæring, primaernaering, toemmer, tømmer ]
keywords: [ grunnlagsdata ]
last_updated: Sep 3, 2025
hide_table_of_contents: true
---

<Summary>Tjeneste for innrapportering av tredjepartsopplysninger om tømmer</Summary>
...
Følgende scope skal benyttes ved autentisering i Maskinporten: `skatteetaten:innrapporteringprimaernaeringtoemmer`
        ...
        "resource": [
            {
                ...
                "value": "ske-innrapportering-primaernaering-toemmer"
            }
        ]
    }
]
...
[SwaggerHub](https://app.swaggerhub.com/apis/skatteetaten/innrapportering-toemmer-api/1.0.0)

Nødvendige åpninger i en evt. brannmur er beskrevet [her](../om/sikkerhet.md)

API-et for innrapportering for tømmer har to endepunkter

* __POST innsending__: Mottar tredjepartsopplysninger om tømmer. Et kall mot API-et er en rapportering for en
...
API-et validerer mottatte data mot JSON schema beskrevet på SwaggerHub. Se [feilkoder](innrapportering-toemmer?tab=Feilkoder) for
relaterte feilmeldinger.

Se også [eksempler](innrapportering-toemmer?tab=Eksempler) for de ulike endepunktene.
...
```
https://innrapporteringprimaernaeringtoemmer.api.{env}.no/v1/{inntektsaar}
```
      ...
      "oppgave": [
        {
          "produkt": "toemmer",
          "beloep": "1200000.00",
          "skogsfondskontonummer": "15011234",
          "aGodskrevetSkogavgift": "50000",
          "bGodskrevneTilskuddOgAndreInnbetalinger": "0",
          "cUtbetaltTilFormaalMedSkattefordel": "0",
          "dGodskrevneTilskuddTilFormaalMedSkattefordel": "0",
          "eDriftstilskudd": "20000",
          "fUtbetaltTilFormaalUtenSkattefordel": "0",
          "gGodskrevneTilskuddTilFormaalUtenSkattefordel": "0",
          "oppgaveeier": {
            "organisasjonsnummer": "999991111",
            "navn": "Hansens naturproduksjon"
          },
          "inngaaendeSaldo": "526000",
          "utgaaendeSaldo": "526000"
        },
        {
          "produkt": "toemmer",
          "beloep": "1100000.00",
          "skogsfondskontonummer": "15011234",
          "aGodskrevetSkogavgift": "0.0",
          "bGodskrevneTilskuddOgAndreInnbetalinger": "0",
          "cUtbetaltTilFormaalMedSkattefordel": "0",
          "dGodskrevneTilskuddTilFormaalMedSkattefordel": "0",
          "eDriftstilskudd": "0",
...
![toemmer](../../static/download/Informasjonsmodell_toemmer.png)
</TabItem>
...
For spesifikke URL-er til testmiljø hos Skatteetaten, se [SwaggerHub](https://app.swaggerhub.com/apis/skatteetaten/innrapportering-toemmer-api/1.0.0).
...
Har du spørsmål til Skatteetaten om tømmer API, kan du sende oss e-post: [altinnreetablering\@skatteetaten.no](mailto:altinnreetablering@skatteetaten.no)  
