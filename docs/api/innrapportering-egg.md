...
[SwaggerHub](https://app.swaggerhub.com/apis/skatteetaten/innrapportering-egg-api/0.0.1)
...
For spesifikke URL-er til testmiljø hos Skatteetaten, se [SwaggerHub](https://app.swaggerhub.com/apis/skatteetaten/innrapportering-egg-api/0.0.1).
