---
title: Innrapportering egg API
slug: /api/innrapportering-egg
folder: api
...
<Summary>Tjeneste for innrapportering av tredjepartsopplysninger om egg</Summary>
...
Følgende scope skal benyttes ved autentisering i Maskinporten: `skatteetaten:innrapporteringprimaernaeringegg`
        ...
        "resource": [
            {
                ...
                "value": "ske-innrapportering-primaernaering-egg"
            }
        ]
    }
]
...
[SwaggerHub](https://app.swaggerhub.com/apis/skatteetaten/innrapportering-egg-api/1.0.0)
...
API-et validerer mottatte data mot JSON schema beskrevet på SwaggerHub. Se [feilkoder](innrapportering-egg?tab=Feilkoder) for
relaterte feilmeldinger.

Se også [eksempler](innrapportering-egg?tab=Eksempler) for de ulike endepunktene.
...
```
https://innrapporteringprimaernaeringegg.api.{env}.no/v1/{inntektsaar}
```
  ...
  "leveranse": {
    ...
    "oppgavegiver": {
      ...
      "kontaktinformasjon": {
        ...
        "varselEpostadresse": "kontakt@example.com",
...
![egg](../../static/download/Informasjonsmodell_egg.png)
</TabItem>
...
For spesifikke URL-er til testmiljø hos Skatteetaten, se [SwaggerHub](https://app.swaggerhub.com/apis/skatteetaten/innrapportering-egg-api/1.0.0).
