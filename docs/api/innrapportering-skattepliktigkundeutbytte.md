...
[SwaggerHub](https://app.swaggerhub.com/apis/skatteetaten/innrapportering-skattepliktig-kundeutbytte-api/0.0.1)
...
For spesifikke URL-er til testmiljø hos Skatteetaten, se [SwaggerHub](https://app.swaggerhub.com/apis/skatteetaten/innrapportering-skattepliktig-kundeutbytte-api/0.0.1).
...
Har du spørsmål til Skatteetaten om Innrapportering skattepliktig kundeutbytte API, kan du sende oss e-post: [altinnreetablering\@skatteetaten.no](mailto:altinnreetablering@skatteetaten.no)  
