...
API-et for innrapportering av boligsameie har to endepunkter
...
For spesifikke URL'er til testmiljø hos Skatteetaten, se [SwaggerHub](https://app.swaggerhub.com/apis/skatteetaten/boligsameie-api/0.0.1). 
