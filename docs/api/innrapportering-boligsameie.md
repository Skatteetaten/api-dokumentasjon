...
[SwaggerHub](https://app.swaggerhub.com/apis/skatteetaten/boligsameie-api/1.0.0)
...
For spesifikke URL-er til testmiljø hos Skatteetaten, se [SwaggerHub](https://app.swaggerhub.com/apis/skatteetaten/boligsameie-api/1.0.0).
