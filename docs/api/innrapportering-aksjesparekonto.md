...
[SwaggerHub](https://app.swaggerhub.com/apis/skatteetaten/innrapportering-aksjesparekonto-api/)
...
* __POST innsending__: Innsending av tredjepartsopplysninger om aksjesparekonto til offentlige myndigheter. Et kall mot API-et er en rapportering for en organisasjon gitt av en oppgavegiver og som gjelder et inntektsår. Maksimal størrelse på request body er 10 mb. 
...
For spesifikke URL-er til testmiljø hos Skatteetaten, se [SwaggerHub](https://app.swaggerhub.com/apis/skatteetaten/innrapportering-aksjesparekonto-api/).
