---
title: Innrapportering melk API
slug: /api/innrapportering-melk
folder: api
...
<Summary>Tjeneste for innrapportering av tredjepartsopplysninger om melk (RF-1301)</Summary>
...
Følgende scope skal benyttes ved autentisering i Maskinporten: `skatteetaten:innrapporteringmelk`
        ...
        "resource": [
            {
                ...
                "value": "ske-innrapportering-primaernaering-melk"
            }
        ]
    }
]
...
[SwaggerHub](https://app.swaggerhub.com/apis/skatteetaten/innrapportering-melk-api/).

Nødvendige åpninger i en evt. brannmur er beskrevet [her](../om/sikkerhet.md).

API-et for innrapportering av tredjepartsopplysninger melk har to endepunkter:

* __POST innsending__: Innsending av tredjepartsopplysninger melk. Et kall mot
  API-et er en rapportering for en organisasjon gitt av en oppgavegiver og som gjelder et inntektsår. Maksimal størrelse på request body er 10 mb. 
...
Se [feilkoder](innrapportering-melk?tab=Feilkoder) for
relaterte feilmeldinger.

Se også [eksempler](innrapportering-melk?tab=Eksempler) for de ulike endepunktene.
...
| GLD_1053               | Uventet feil i et bakenforliggende system, vennligst prøv igjen senere                      | Intern feil i skatteetatens systemer.                                                                                       |
...
For spesifikke URL-er til testmiljø hos Skatteetaten, se [SwaggerHub](https://app.swaggerhub.com/apis/skatteetaten/innrapportering-melk-api/).
