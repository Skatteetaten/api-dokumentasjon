...
<Summary>Tjeneste for innsending av skattemelding.</Summary>
...
### Scope
Følgende scope skal benyttes ved autentisering i Maskinporten: `skatteetaten:formueinntekt/skattemelding`
