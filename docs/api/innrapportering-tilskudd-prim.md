        ...
        "resource": [
            {
                ...
                "value": "ske-innrapportering-primaernaering-tilskudd"
            }
        ]
    }
]
...
[SwaggerHub](https://app.swaggerhub.com/apis/skatteetaten/innrapportering-tilskudd-erstatning-mv-primaer-api/1.0.0)
...
For spesifikke URL-er til testmiljø hos Skatteetaten, se [SwaggerHub](https://app.swaggerhub.com/apis/skatteetaten/innrapportering-tilskudd-erstatning-mv-primaer-api/1.0.0).
