...
[SwaggerHub](https://app.swaggerhub.com/apis/skatteetaten/innrapportering-fisk-api/)
...
For spesifikke URL-er til testmiljø hos Skatteetaten, se [SwaggerHub](https://app.swaggerhub.com/apis/skatteetaten/innrapportering-fisk-api/).
