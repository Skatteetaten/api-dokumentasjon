---
title: Innrapportering slakt API
slug: /api/innrapportering-slakt
folder: api
sidebar: mydoc_sidebar
datatable: true
tags: [ API, primærnæring, primaernaering, slakt ]
keywords: [ grunnlagsdata ]
last_updated: Sep 3, 2025
hide_table_of_contents: true
---

<Summary>Tjeneste for innrapportering av tredjepartsopplysninger om slakt</Summary>
...
Følgende scope skal benyttes ved autentisering i Maskinporten: `skatteetaten:innrapporteringprimaernaeringslakt`
        ...
        "resource": [
            {
                ...
                "value": "ske-innrapportering-primaernaering-slakt"
            }
        ]
    }
]
...
[SwaggerHub](https://app.swaggerhub.com/apis/skatteetaten/innrapportering-slakt-api/1.0.0)

Nødvendige åpninger i en evt. brannmur er beskrevet [her](../om/sikkerhet.md)

API-et for innrapportering for slakt har to endepunkter

* __POST innsending__: Mottar tredjepartsopplysninger om slakt. Et kall mot API-et er en rapportering for en
...
API-et validerer mottatte data mot JSON schema beskrevet på SwaggerHub. Se [feilkoder](innrapportering-slakt?tab=Feilkoder) for
relaterte feilmeldinger.

Se også [eksempler](innrapportering-slakt?tab=Eksempler) for de ulike endepunktene.
...
```
https://innrapporteringprimaernaeringslakt.api.{env}.no/v1/{inntektsaar}
```
...
![slakt](../../static/download/Informasjonsmodell_slakt.png)
</TabItem>
...
For spesifikke URL-er til testmiljø hos Skatteetaten, se [SwaggerHub](https://app.swaggerhub.com/apis/skatteetaten/innrapportering-slakt-api/1.0.0).
...
Har du spørsmål til Skatteetaten om slakt API, kan du sende oss e-post: [altinnreetablering\@skatteetaten.no](mailto:altinnreetablering@skatteetaten.no)  
